      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-4">
            <h3 className="font-serif text-xl font-medium text-gold">Bespoke Thai Journeys</h3>
            <p className="text-white/80 text-sm leading-relaxed">
              Elevating your Thai experience through personalized luxury concierge services, ensuring comfort and exclusivity at every step.
            </p>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/blog" className="text-white/70 hover:text-gold transition-colors text-sm">Journal</Link>
              </li>
              <li>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li className="text-white/70 text-sm">VIP Services</li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center space-x-3">
                ...
                <a href="mailto:contact@bespokethai.com" className="text-white/70 hover:text-white text-sm">contact@bespokethai.com</a>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-white/10 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center text-sm text-white/60">
          <p>© {new Date().getFullYear()} Bespoke Thai Journeys. All rights reserved.</p>
